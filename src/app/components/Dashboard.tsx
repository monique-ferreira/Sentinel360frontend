...
export function Dashboard() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {!error && !loading && total === 0 && <div className="flex items-center gap-2 p-3 rounded-lg bg-blue-50 border border-blue-200 text-sm text-blue-700"><Wifi className="h-4 w-4 shrink-0"/>Nenhum scan realizado. Execute o agente para popular os dados.</div>}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard title="Com riscos" value={loading ? "—" : riscos.toLocaleString("pt-BR")} subtitle="credenciais / tokens" icon={<ShieldAlert className="h-5 w-5"/>} color="danger" />
